            ...
            <Modal
                ...
                footer={
                    <>
                        ...
                        <p>Already have an account? <a href="#" onClick={() => setModal(true)} style={{color: "var(--color-secondary)"}}>Login</a></p>
                    </>
                }
            ...
            <div onClick={handleMenuState} className="header-container vw-container">
                <div onClick={(e) => e.stopPropagation()} className="header-inner">
                    ...
                    <div className="header-item header-signup">
                        <Button state="button-invert" onClick={() => setModal(true)}>Login</Button>
